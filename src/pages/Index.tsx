...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-100">
      <nav className="fixed top-0 left-0 right-0 z-50 glass">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="text-lg font-heading font-medium text-primary">
              Екатерина Мурашова
            </div>
        ...
        <div className="container mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8 animate-fade-in">
              <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-medium text-primary leading-tight">
              ...
              <Button
                onClick={() => setShowContactDialog(true)}
                size="lg"
                className="btn-glow px-8 py-6 text-base font-normal rounded-sm"
              >
            ...
            <div className="animate-fade-in-delayed opacity-0">
              <div className="glass rounded-sm overflow-hidden">
                <img
                  src="https://cdn.poehali.dev/projects/b9191a94-5507-443c-a32b-433cd6c29d95/files/f93a8f9d-c730-4225-bb25-4fe2a6f3afbc.jpg"
                  alt="Екатерина Мурашова"
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-4">
            {[
              ...
              <div
                key={i}
                className="glass p-6 rounded-sm flex items-start gap-4 hover:bg-white/60 transition-all"
              >
                <div className="text-accent-foreground text-xl mt-1">•</div>
                <p className="text-lg text-foreground font-light">{text}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={i}
                className="glass p-8 rounded-sm space-y-4 hover:scale-105 transition-transform"
              >
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-4xl">
          <div className="glass-dark p-12 rounded-sm text-center space-y-6">
      ...
      <section id="about" className="py-20 px-6 bg-white/50">
        <div className="container mx-auto max-w-4xl text-center space-y-8">
          ...
          <p className="text-lg md:text-xl text-muted-foreground font-light leading-relaxed max-w-3xl mx-auto">
            Я работаю на стыке психологии, интуиции, эстетики и системного
      ...
      <section id="format" className="py-20 px-6">
        <div className="container mx-auto max-w-5xl space-y-12">
          <h2 className="font-heading text-3xl md:text-4xl font-medium text-primary text-center">
            Формат работы
          </h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={i}
                className="glass p-6 rounded-sm flex flex-col items-center gap-4 text-center hover:bg-white/60 transition-all"
              >
        ...
        <div className="container mx-auto max-w-6xl space-y-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={i}
                className="glass p-8 rounded-sm space-y-6 hover:scale-105 transition-transform"
              >
                <h3 className="font-heading text-xl font-medium text-primary">
                  {service.title}
                </h3>
                ...
                <Button
                  onClick={() => setShowContactDialog(true)}
                  variant="outline"
                  className="w-full btn-glow rounded-sm"
                >
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-4xl">
          <div className="glass p-12 rounded-sm text-center space-y-8">
      ...
      <footer className="py-12 px-6 bg-primary text-primary-foreground">
        <div className="container mx-auto text-center space-y-4">
          <p className="font-heading text-lg">Екатерина Мурашова</p>
          <p className="text-sm font-light opacity-80">
            Психолог · Стратег · Навигатор смыслов
          </p>
        </div>
      </footer>
        ...
        <DialogContent className="glass">
          ...
          <div className="space-y-4 pt-4">
            <a
              ...
              className="flex items-center gap-4 glass p-6 rounded-sm hover:bg-white/60 transition-all group"
            >
              <Icon
                name="MessageCircle"
                size={32}
